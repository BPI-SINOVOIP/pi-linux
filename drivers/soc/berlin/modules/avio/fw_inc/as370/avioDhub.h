...
#define h_avioDhubChMap (){}
    ...
    #define        avioDhubChMap_aio64b_SEC0_R                              0x7
    #define        avioDhubChMap_aio64b_BCM_R                               0x8
    #define        avioDhubChMap_aio64b_MIC1_PDM_W1                         0x9
    #define        avioDhubChMap_aio64b_PDM_W0                              0xA
    #define        avioDhubChMap_aio64b_PDM_W1                              0xB
    #define        avioDhubChMap_aio64b_MIC2_W0                             0xC
    #define        avioDhubChMap_aio64b_reserved_9                          0xD
...
#define h_avioDhubTcmMap (){}
    ...
    #define        avioDhubTcmMap_aio64bDhub_BANK0_SIZE        0x3200
...
#define h_avioDhubSemMap (){}
    ...
    #define        avioDhubSemMap_aio64b_aio_intr9reserved                  0x19
    #define        avioDhubSemMap_aio64b_aio_intr10reserved                 0x1A
    #define        avioDhubSemMap_aio64b_aio_intr11reserved                 0x1B
