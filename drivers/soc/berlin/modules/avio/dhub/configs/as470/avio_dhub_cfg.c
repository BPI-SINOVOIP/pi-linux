...
DHUB_channel_config  AG_config[AG_NUM_OF_CHANNELS] = {
	...
	{ avioDhubChMap_aio64b_MIC1_W1, AG_DHUB_BANK0_START_ADDR+512*5, \
	  ...
	  dHubChannel_CFG_MTU_128byte, 0, 0, 1},
	{ avioDhubChMap_aio64b_MIC2_CH_W, AG_DHUB_BANK0_START_ADDR+512*6, \
	  AG_DHUB_BANK0_START_ADDR+512*6+32, 32, (512-32), \
	  dHubChannel_CFG_MTU_128byte, 0, 0, 1},
	{ avioDhubChMap_aio64b_MA7_R, AG_DHUB_BANK0_START_ADDR+512*7, \
	...
	{ avioDhubChMap_aio64b_BCM_R, AG_DHUB_BANK0_START_ADDR+512*11, \
	  ...
	  dHubChannel_CFG_MTU_128byte, 0, 0, 1},
	{ avioDhubChMap_aio64b_MA19_W, AG_DHUB_BANK0_START_ADDR+512*12, \
	  AG_DHUB_BANK0_START_ADDR+512*12+32, 32, (512-32), \
	  dHubChannel_CFG_MTU_128byte, 0, 0, 1},
	{ avioDhubChMap_aio64b_MIC4_CH_W, AG_DHUB_BANK0_START_ADDR+512*13, \
	  AG_DHUB_BANK0_START_ADDR+512*13+32, 32, (512-32), \
	  dHubChannel_CFG_MTU_128byte, 0, 0, 1},
	{ avioDhubChMap_aio64b_MA11_W, AG_DHUB_BANK0_START_ADDR+512*14, \
	  AG_DHUB_BANK0_START_ADDR+512*14+32, 32, (512-32), \
	  dHubChannel_CFG_MTU_128byte, 0, 0, 1},
	{ avioDhubChMap_aio64b_PDM_CH_R, AG_DHUB_BANK0_START_ADDR+512*15, \
	  AG_DHUB_BANK0_START_ADDR+512*15+32, 32, (512-32), \
	  dHubChannel_CFG_MTU_128byte, 0, 0, 1},
	{ avioDhubChMap_aio64b_MA13_R, AG_DHUB_BANK0_START_ADDR+512*16, \
