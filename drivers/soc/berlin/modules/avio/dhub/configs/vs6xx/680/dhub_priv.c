...
#define AVIO_DHUB_MV_R0_SIZE       (7680)
#define AVIO_DHUB_VMM_VX_R_SIZE    (512)
#define AVIO_DHUB_MV_R1_SIZE       (5120)
#define AVIO_DHUB_OVPSCL_W0_SIZE   (2880)
#define AVIO_DHUB_MV_R2_SIZE       (512)
#define AVIO_DHUB_GFX_PIP_R0_SIZE  (11520)
#define AVIO_DHUB_PIP_R1_SIZE      (2400)
#define AVIO_DHUB_GFX_R1_SIZE      (23040)
#define AVIO_DHUB_MV_R3_SIZE       (512)
#define AVIO_DHUB_1DSCL_W0_SIZE    (7200)
#define AVIO_DHUB_1DSCL_W1_SIZE    (1536)
#define AVIO_DHUB_MetaData_RD_SIZE (512)
#define AVIO_DHUB_DBEDR_RD_SIZE    (8640)
#define AVIO_DHUB_OVPSCL_W1_SIZE   (1920)
#define AVIO_DHUB_OVPSCL_R0_SIZE   (7680)
#define AVIO_DHUB_OVPSCL_R1_SIZE   (5120)
...
#define AVIO_DHUB_OVPSCL_W0_BASE   (AVIO_DHUB_MV_R1_BASE + AVIO_DHUB_MV_R1_SIZE)
#define AVIO_DHUB_MV_R2_BASE	   (AVIO_DHUB_OVPSCL_W0_BASE + AVIO_DHUB_OVPSCL_W0_SIZE)
#define AVIO_DHUB_GFX_PIP_R0_BASE  (AVIO_DHUB_MV_R2_BASE + AVIO_DHUB_MV_R2_SIZE)
#define AVIO_DHUB_PIP_R1_BASE	  (AVIO_DHUB_GFX_PIP_R0_BASE + AVIO_DHUB_GFX_PIP_R0_SIZE)
#define AVIO_DHUB_GFX_R1_BASE	  (AVIO_DHUB_PIP_R1_BASE + AVIO_DHUB_PIP_R1_SIZE)
#define AVIO_DHUB_MV_R3_BASE	   (AVIO_DHUB_GFX_R1_BASE + AVIO_DHUB_GFX_R1_SIZE)
#define AVIO_DHUB_1DSCL_W0_BASE	    (AVIO_DHUB_MV_R3_BASE + AVIO_DHUB_MV_R3_SIZE)
...
#define AVIO_DHUB_OVPSCL_W1_BASE   (AVIO_DHUB_DBEDR_RD_BASE + AVIO_DHUB_DBEDR_RD_SIZE)
#define AVIO_DHUB_OVPSCL_R0_BASE   (AVIO_DHUB_OVPSCL_W1_BASE + AVIO_DHUB_OVPSCL_W1_SIZE)
#define AVIO_DHUB_OVPSCL_R1_BASE   (AVIO_DHUB_OVPSCL_R0_BASE + AVIO_DHUB_OVPSCL_R0_SIZE)
...
DHUB_channel_config  VPP_config[VPP_NUM_OF_CHANNELS] = {
	...
	{ avioDhubChMap_vpp128b_OVPSCL_W0, AVIO_DHUB_OVPSCL_W0_BASE, AVIO_DHUB_OVPSCL_W0_BASE+64, 64, (AVIO_DHUB_OVPSCL_W0_SIZE-64), dHubChannel_CFG_MTU_256byte, 0, 0, 1, 0x7, 0x7},
	{ avioDhubChMap_vpp128b_MV_R2, AVIO_DHUB_MV_R2_BASE, AVIO_DHUB_MV_R2_BASE+64, 64, (AVIO_DHUB_MV_R2_SIZE-64), dHubChannel_CFG_MTU_256byte, 1, 0, 1, 0xF, 0xF},
	{ avioDhubChMap_vpp128b_GFX_PIP_R0, AVIO_DHUB_GFX_PIP_R0_BASE, AVIO_DHUB_GFX_PIP_R0_BASE+64, 64, (AVIO_DHUB_GFX_PIP_R0_SIZE-64), dHubChannel_CFG_MTU_256byte, 1, 0, 1, 0xF, 0xF},
	{ avioDhubChMap_vpp128b_PIP_R1, AVIO_DHUB_PIP_R1_BASE, AVIO_DHUB_PIP_R1_BASE+64, 64, (AVIO_DHUB_PIP_R1_SIZE-64), dHubChannel_CFG_MTU_256byte, 1, 0, 1, 0xF, 0xF},
	...
	{ avioDhubChMap_vpp128b_MV_R3, AVIO_DHUB_MV_R3_BASE, AVIO_DHUB_MV_R3_BASE+64, 64, (AVIO_DHUB_MV_R3_SIZE-64), dHubChannel_CFG_MTU_256byte, 1, 0, 1, 0xF, 0xF},
	...
	{ avioDhubChMap_vpp128b_OVPSCL_W1, AVIO_DHUB_OVPSCL_W1_BASE, AVIO_DHUB_OVPSCL_W1_BASE+64, 64, (AVIO_DHUB_OVPSCL_W1_SIZE-64), dHubChannel_CFG_MTU_256byte, 0, 0, 1, 0x7, 0x7},
	{ avioDhubChMap_vpp128b_OVPSCL_R0, AVIO_DHUB_OVPSCL_R0_BASE, AVIO_DHUB_OVPSCL_R0_BASE+64, 64, (AVIO_DHUB_OVPSCL_R0_SIZE-64), dHubChannel_CFG_MTU_256byte, 0, 0, 1, 0x7, 0x7},
	{ avioDhubChMap_vpp128b_OVPSCL_R1, AVIO_DHUB_OVPSCL_R1_BASE, AVIO_DHUB_OVPSCL_R1_BASE+64, 64, (AVIO_DHUB_OVPSCL_R1_SIZE-64), dHubChannel_CFG_MTU_256byte, 0, 0, 1, 0x7, 0x7},
};


#define AIO_DHUB_PRI_SIZE		    (2048)
#define AIO_DHUB_GFX2_R1_SIZE	    (7680)
#define AIO_DHUB_SEC_SIZE		    (512)
#define AIO_DHUB_SPDIF1_SIZE		(2048)
...
#define AIO_DHUB_MIC3_SIZE		    (2048)
...
#if defined(avioDhubChMap_aio64b_MA3_W)
#define  avioDhubChMap_aio64b_MA3_CH avioDhubChMap_aio64b_MA3_W
#elif defined(avioDhubChMap_aio64b_MA3_R)
#define  avioDhubChMap_aio64b_MA3_CH avioDhubChMap_aio64b_MA3_R
#endif
...
DHUB_channel_config  AG_config[AG_NUM_OF_CHANNELS] = {
	...
	{ avioDhubChMap_aio64b_GFX2_R, AIO_DHUB_GFX2_R1_BASE, AIO_DHUB_GFX2_R1_BASE+64, 64, (AIO_DHUB_GFX2_R1_SIZE-64), dHubChannel_CFG_MTU_256byte, 1, 0, 1, 0xF, 0xF},
	...
	{ avioDhubChMap_aio64b_MA3_CH, AIO_DHUB_SPDIF1_BASE, AIO_DHUB_SPDIF1_BASE+32, 32, (AIO_DHUB_SPDIF1_SIZE-32), dHubChannel_CFG_MTU_128byte, 0, 0, 1, 0xF, 0xF},
	...
	{ avioDhubChMap_aio64b_BCM_R, AIO_DHUB_BCM_BASE, AIO_DHUB_BCM_BASE+128, 128, (AIO_DHUB_BCM_SIZE-128), dHubChannel_CFG_MTU_256byte, 1, 0, 1, 0xF, 0xF},
