...
static const struct cpg_core_clk r9a09g056_core_clks[] __initconst = {
	...
	DEF_DDIV(".pllvdo_isp", CLK_PLLVDO_ISP, CLK_PLLVDO, CDDIVx_DIVCTLy(2, 3, 0), dtable_2_4),
...
static const struct rzv2h_mod_clk r9a09g056_mod_clks[] __initconst = {
	...
	DEF_MOD("isp_reg_aclk",			CLK_PLLDTY_ACPU_DIV2, 14, 2, 7, 2),
	DEF_MOD("isp_pclk",				CLK_PLLDTY_DIV16, 14, 3, 7, 3),
	DEF_MOD("isp_vin_aclk",			CLK_PLLDTY_ACPU_DIV2, 14, 4, 7, 4),
	DEF_MOD("isp_sclk",				CLK_PLLVDO_ISP, 14, 5, 7, 5),
...
static const struct rzv2h_reset r9a09g056_resets[] __initconst = {
	...
	DEF_RST(13, 1, 6, 2),		/* ISP_VIN_ARESETN */
	DEF_RST(13, 2, 6, 3),		/* ISP_REG_ARESETN */
	DEF_RST(13, 3, 6, 4),		/* ISP_ISP_SRESETN */
	DEF_RST(13, 4, 6, 5),		/* ISP_PRESETN */
