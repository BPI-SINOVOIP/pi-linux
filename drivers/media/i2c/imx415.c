...
static const struct imx415_reg imx415_mode_2_720[] = {
	{ IMX415_VMAX, 0x08CA },
	{ IMX415_HMAX, 0x07F0 },
	{ IMX415_LANEMODE, IMX415_LANEMODE_2 }, /* CHECKME: was LANEMODE_2 */
...
static const struct imx415_reg imx415_mode_2_891[] = {
	{ IMX415_VMAX, 0x08CA },
	{ IMX415_HMAX, 0x0898 },
...
static const struct imx415_mode supported_modes[] = {
	...
	{ /* 891, 2lane, 15fps, 37.125MHz, 74.25MHz */
		.lane_rate = 891000000,
		.lanes = 2,
		.hmax_pix = 4400,
	...
	{ /* 891, 4lane, 30fps, 37.125MHz, 74.25MHz */
		.lane_rate = 891000000,
		.lanes = 4,
		.hmax_pix = 4400,
...
__imx415_get_pad_format(struct imx415 *imx415,
			struct v4l2_subdev_state *sd_state,
			unsigned int pad,
			enum v4l2_subdev_format_whence which)
{
	...
	case V4L2_SUBDEV_FORMAT_TRY:
		return v4l2_subdev_get_try_format(&imx415->subdev, sd_state, pad);
	case V4L2_SUBDEV_FORMAT_ACTIVE:
		return &imx415->format;
	default:
		return NULL;
	}
}
			     ...
			     struct v4l2_subdev_format *fmt)
{
	...
	fmt->format = *__imx415_get_pad_format(imx415, sd_state,
						  fmt->pad,
						  fmt->which);
	return 0;
}
			     ...
			     struct v4l2_subdev_format *fmt)
{
	...
	format = __imx415_get_pad_format(imx415, sd_state, fmt->pad,
						  fmt->which);
...
static int imx415_init_cfg(struct v4l2_subdev *subdev,
				  struct v4l2_subdev_state *sd_state)
{
	struct v4l2_subdev_format fmt = { 0 };

	fmt.which = sd_state ? V4L2_SUBDEV_FORMAT_TRY : V4L2_SUBDEV_FORMAT_ACTIVE;
	fmt.format.width = IMX415_PIXEL_ARRAY_WIDTH;
	fmt.format.height = IMX415_PIXEL_ARRAY_HEIGHT;

	imx415_set_format(subdev, sd_state, &fmt);
...
static int imx415_parse_hw_config(struct imx415 *sensor)
{
	...
	ret = 0;
	dev_info(sensor->dev, "clock: %lu Hz, lane_rate: %llu bps, lanes: %d\n",
