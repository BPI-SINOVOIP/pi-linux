...
#define SN6040_RATES					SNDRV_PCM_RATE_48000
#define SN6040_RATES_NEW				SNDRV_PCM_RATE_44100|SNDRV_PCM_RATE_48000
#define SN6040_FORMATS					SNDRV_PCM_FMTBIT_S32_LE
// #define SN6040_FORMATS				SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE

#define SND_SN6040_JACK_MASK			(SND_JACK_HEADSET | SND_JACK_BTN_0 | SND_JACK_BTN_1 | SND_JACK_BTN_2)
...
union sn6040_reg_i2spcm_ctrl_reg1 {
	struct {
		u32 rx_data_one_line:1;//1 
		u32 rx_ws_pol:1;// 1
		u32 rx_ws_wid:7;//1f 0 011111 低位 f 0001111
		u32 rx_frm_len:5;//7 00111 3 //00011
		u32 rx_sa_size:2;//01 高位 0x6e01

		u32 tx_data_one_line:1;//1 
		u32 tx_ws_pol:1;
		u32 tx_ws_wid:7;//1f
		u32 tx_frm_len:5;//7
		u32 tx_sa_size:2;//1
